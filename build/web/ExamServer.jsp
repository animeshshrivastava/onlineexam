...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/exam?zeroDateTimeBehavior=convertToNull","root","123");Statement stmt=con.createStatement();
