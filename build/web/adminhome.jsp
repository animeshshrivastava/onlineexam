...
<div id="wrapper">
	<div id="header-wrapper">
		<div id="header" class="container">
			<div id="logo">
				<h1><a href="index.jsp">Online Exam</a></h1>
			</div>
			<div id="menu">
				<ul>
					<li class="current_page_item"><a href="adminhome.jsp">Home</a></li>
					  <li><a href="allrec2.jsp">User Details</a></li>
                                         ...
                                         <li><a href="questForm.jsp">Add Questions</a></li>
                                           <li><a href="result.jsp">Exam Result</a></li>
	...
	<div id="page">
		<div id="content">
			<div class="post">
				...
				<div class="entry">
					<p><a href="#"><img src="images/img2.jpg" width="600" height="200" alt="" /></a></p>
