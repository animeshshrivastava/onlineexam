...
<hr />
		...
		<table width="100%">
			<tr align="center">
				<td>
				<form action="./allrec2.jsp" method="post" id="home_form"
      ...
      Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/exam?zeroDateTimeBehavior=convertToNull", "root", "123");
 		...
 		boolean count = false;
 			...
 			PreparedStatement ps = con
 					.prepareStatement("SELECT * FROM question_detail");
 ...
 %>
				...
				<td><%=rs.getString("qa")%></td>
				
				<td><%=rs.getString("qb")%></td>
                                <td><%=rs.getString("qc")%></td>
                                <td><%=rs.getString("qd")%></td>
